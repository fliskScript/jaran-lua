...
function library:New(name)
	...
	local Jaran = Instance.new("ScreenGui")
	...
	Jaran.Name = "Jaran"
	Jaran.ResetOnSpawn = false
	Jaran.ZIndexBehavior = "Global"
	Jaran.DisplayOrder = 420133769

	local UIScale = Instance.new("UIScale")
	UIScale.Parent = Jaran
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key)
		if key.KeyCode == Enum.KeyCode.Insert then
			Jaran.Enabled = not Jaran.Enabled
			library.uiopen = Jaran.Enabled
		end
	end)
